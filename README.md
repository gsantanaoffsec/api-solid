...
- [x] O usuário deve ser identificado po um JWT (JSON Web Token);

# JWT: JSON Web Token

- Usuário faz login, envia e-mail/senha, o back-end cria um token ÚNICO, não modificá vel e STATELESS
